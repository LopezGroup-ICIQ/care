...
from tests import test_inters, surface, inter_from_poscar, surface_from_slab
...
class TestAdsorbatePlacement(unittest.TestCase):
    ...
    def test_specific_config(self):
        ...
        """
        adsorptions = place_adsorbate(inter_from_poscar, surface_from_slab, 1, surface_sites=[38,39,40], adsorbate_atom=2)
        ...
        adsorbate_anchoring_atom_graph_idx = graph.idx.index(2+ n_slab-1)  # adsorbate atom used for placement
